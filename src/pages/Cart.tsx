...
const Cart = () => {
      ...
      <div className="min-h-screen bg-white dark:bg-gray-900 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center py-20">
            <div className="text-primary text-xl font-medium">Loading cart...</div>
          </div>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-white dark:bg-gray-900 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center py-20">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-8">Start adding products to your cart</p>
            <Link
              to="/products"
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold mb-12 text-gray-900 dark:text-white">Shopping Cart</h1>
