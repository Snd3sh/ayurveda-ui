  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        const errorMessage = response.message || response.error || 'Failed to create order. Please try again.';
        alert(errorMessage);
      }
    } catch (error: any) {
          ...
          <div className="lg:col-span-2">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 border border-gray-100 dark:border-gray-700">
              ...
              <div className="space-y-5">
                <div>
                  <label className="block font-semibold mb-2 text-gray-900 dark:text-white">Full Name</label>
                  <input
                    type="text"
                    name="fullName"
                    required
                ...
                <div>
                  <label className="block font-semibold mb-2 text-gray-900 dark:text-white">Phone</label>
                  <input
                    type="tel"
                    name="phone"
                    required
                ...
                <div>
                  <label className="block font-semibold mb-2 text-gray-900 dark:text-white">Address</label>
                  <input
                    type="text"
                    name="address"
                    required
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block font-semibold mb-2 text-gray-900 dark:text-white">City *</label>
                    <select
                      name="city"
                      required
                      value={formData.city}
                  ...
                  <div>
                    <label className="block font-semibold mb-2 text-gray-900 dark:text-white">State/Province</label>
                    <input
                      type="text"
                      name="state"
                      required
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block font-semibold mb-2 text-gray-900 dark:text-white">Postal Code</label>
                    <input
                      type="text"
                      name="postalCode"
                      required
                  ...
                  <div>
                    <label className="block font-semibold mb-2 text-gray-900 dark:text-white">Country</label>
                    <input
                      type="text"
                      name="country"
                      required
